...
\hyperref[Datasets]{Fig. 3} represents an overview of different state-of-the-art datasets, while \hyperref[table:datasetcomparison]{Table 1.1} provides an analytical comparison of each of them.
...
\begin{table}[ht]
    ...
    \hline\hline
    Dataset & Samples \# & Type & Participants \# & Gaze Points \# \\ [0.5ex]
        \hline
            GazeCapture & 3 & 200 & 3 & 3 \\
            MMPIIGaze & 3 & 200 & 3 & 3 \\
            CAVE & 3 & 200 & 3 & 3 \\
            ETHXGaze & 3 & 200 & 3 & 3 \\ [1ex]
        \hline
    \end{tabular}
...
\chapter{Evaluation}
\label{Chap2}
\lhead{Chapter 2. \emph{Evaluation}}
